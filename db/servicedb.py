...
if __name__ == "__main__":
    ...
    caminhoBD = input("Digite o caminho para o banco de dados: ").replace('"',"").strip()
    if(caminhoBD == ""):
        caminhoBD = "C:\\Users\\Victtoria\\OneDrive\\Desktop\\necessaryMarcus\\Projetos\\ChatBotUniversal\\database\\chatbot.db"
    print("CaminhoBD - "+str(caminhoBD))
    servico_db = ServicoSQLite(caminhoBD)
    ...
    """
    servico_db.executar_query(query)
